...
<head>
    ...
    <title>中药复方数据挖掘系统--生物医药循证分析平台V3.5.1</title>
    <style>
        /* Global Styles */
        body {
...
<div class="main_body">
    ...
    <div class="button_container2">
        <form id="loginForm">
            ...
            <a id="login_out" href="logout.php"><?php echo '退出' ?></a>
    ...
    <form action="upload.php" method="post" enctype="multipart/form-data">
        ...
        <div class="button_container">
            ...
            <input id="submit_button" type="submit" value="上传">
        </div>
        <div class="button_container">
            <a class="file_a" href="数据挖掘模板.xlsx" download>下载数据挖掘模板.xlsx</a>
        </div>
    ...
    <div>
        ...
        if (isset($_COOKIE['username']) && isset($_COOKIE['token']) && isset($_COOKIE['user_id']) &&
            ...
            function queryAndOutputAsTable($phoneNumber) {
                ...
                // 输出HTML表格
                echo '<table>';
                echo '<tr><th>文件名</th><th>上传时间</th><th>状态</th><th>下载地址</th></tr>';
